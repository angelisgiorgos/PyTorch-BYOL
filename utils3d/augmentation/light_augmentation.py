...
def augment_light(batch_size,
    ...
    light_t = augment_light_t(batch_size=batch_size,
                              device=device,
                              loc_r_range=config.AUGMENT_RGB['LIGHT_LOC_RANGE'])
    ambient, diffuse, specular = augment_light_colour(batch_size=batch_size,
                                                      device=device,
                                                      ambient_intensity_range=config.AUGMENT_RGB['LIGHT_AMBIENT_RANGE'],
                                                      diffuse_intensity_range=config.AUGMENT_RGB['LIGHT_DIFFUSE_RANGE'],
                                                      specular_intensity_range=config.AUGMENT_RGB['LIGHT_SPECULAR_RANGE'])
